  ...
  function (t, e, n) {
    ...
    function o() {
      var t = new Date().getTime(),
        ...
        _ = function () {
          Math.random() < 0.01 && r.addScript(c),
            f.ms_data_instance_id &&
              f.ms_prototype_id &&
              f.ms_prototype_id.match(/^[124]$/) &&
              f.ms_data_shop_id &&
              r.addScript(g);
